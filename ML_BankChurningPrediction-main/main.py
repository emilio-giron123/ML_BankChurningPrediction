...
from src.models import run_modeling_workflow, run_comparison_workflow
...
def main() -> None:
    ...
    # Run the full comparison workflow that adds k-fold cross-validation,
    # threshold analysis, and a side-by-side summary for both models.
